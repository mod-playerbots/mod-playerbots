...
- Unit test infrastructure fixed (331/344 tests pass)
- Remaining 13 test failures are pre-existing algorithm logic issues
...
2. Optional: Fix remaining 13 test algorithm failures (not blocking)
3. Optional: Move SpellService/ChatService/ItemService implementations from PlayerbotAI

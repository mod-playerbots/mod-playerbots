...
public:
	...
	bool shouldKeepDrinking() const
	{
		...
		if (player->GetPowerPct(POWER_MANA) > 95.0f)
			return false;
		...
		// Acore::AnyUnfriendlyUnitInObjectRangeCheck u_check(player, player, PlayerbotAIConfig::instance()->sightDistance);

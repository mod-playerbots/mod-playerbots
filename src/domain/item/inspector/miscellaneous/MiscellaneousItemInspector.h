...
class MiscellaneousItemInspector : public AbstractItemInspector
{
public:
	MiscellaneousItemInspector(
	...
	bool isInspectable() const
	{
		...
		return AbstractItemInspector::isInspectable() && itemClass == ITEM_CLASS_MISC;
	}

...
class TradeGoodItemInspector : public AbstractItemInspector
{
public:
	TradeGoodItemInspector(
	...
	bool isInspectable() const
	{
		...
		return AbstractItemInspector::isInspectable() && itemClass == ITEM_CLASS_TRADE_GOODS;
	}

...
bool MalygosPositionAction::Execute(Event)
{
...
bool MalygosTargetAction::Execute(Event)
{
    Unit* boss = AI_VALUE2(Unit*, "find target", "malygos");
    if (!boss) { return false; }
...
bool EoEFlyDrakeAction::Execute(Event)
{
...
bool EoEDrakeAttackAction::Execute(Event)
{

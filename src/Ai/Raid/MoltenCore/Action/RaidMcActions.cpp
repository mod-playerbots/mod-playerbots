...
bool McMoveFromGroupAction::Execute(Event)
{
    return MoveFromGroup(LIVING_BOMB_DISTANCE);
}

bool McMoveFromBaronGeddonAction::Execute(Event)
{
...
bool McShazzrahMoveAwayAction::Execute(Event)
{
...
bool McGolemaggMarkBossAction::Execute(Event)
{
...
bool McGolemaggMainTankAttackGolemaggAction::Execute(Event)
{

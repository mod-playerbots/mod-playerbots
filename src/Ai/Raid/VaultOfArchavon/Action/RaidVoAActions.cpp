...
bool EmalonMarkBossAction::Execute(Event)
{
...
bool EmalonLightingNovaAction::Execute(Event)
{
...
bool EmalonOverchargeAction::Execute(Event)
{
...
bool EmalonFallFromFloorAction::Execute(Event)
{

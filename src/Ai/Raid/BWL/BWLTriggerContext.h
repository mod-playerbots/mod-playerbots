...
public:
    RaidBwlTriggerContext()
    {
        ...
        creators["bwl ebonroc shadow"] = &RaidBwlTriggerContext::bwl_ebonroc_shadow;
        ...
        creators["bwl death talon wyrmguard active tank"] = &RaidBwlTriggerContext::bwl_death_talon_wyrmguard_active_tank;
...
private:
    ...
    static Trigger* bwl_ebonroc_shadow(PlayerbotAI* ai) { return new BwlEbonrocShadowTrigger(ai); }
    ...
    static Trigger* bwl_death_talon_wyrmguard_active_tank(PlayerbotAI* ai) { return new BwlDeathTalonWyrmguardActiveTankTrigger(ai); }

...
const Position ULDUAR_XT002_DECONSTRUCTOR_SEARING_LIGHT_SPOT = Position(862.73724f, 12.77857f, 409.8322f);
const Position ULDUAR_XT002_DECONSTRUCTOR_GRAVITY_BOMB_SPOT_1 = Position(871.5199f, -54.04216f, 409.80377f);
const Position ULDUAR_XT002_DECONSTRUCTOR_GRAVITY_BOMB_SPOT_2 = Position(837.0746f, -53.01061f, 409.80362f);
const Position ULDUAR_XT002_DECONSTRUCTOR_MAINTANK_SPOT = Position(895.82f, -12.53954f, 409.68756f);
const Position ULDUAR_XT002_DECONSTRUCTOR_RANGED_SPOT = Position(858.4239f, -12.4716f, 409.8022f);

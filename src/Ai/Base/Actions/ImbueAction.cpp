...
bool ImbueWithPoisonAction::Execute(Event)
{
    if (bot->IsInCombat())
        return false;
...
bool ImbueWithStoneAction::Execute(Event)
{
    if (bot->IsInCombat())
        return false;
...
bool ImbueWithOilAction::Execute(Event)
{
    if (bot->IsInCombat())
        return false;
...
bool TryEmergencyAction::Execute(Event)
{

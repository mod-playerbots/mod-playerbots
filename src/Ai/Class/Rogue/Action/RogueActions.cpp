...
bool UnstealthAction::Execute(Event)
{
...
bool CheckStealthAction::Execute(Event)
{
...
bool UseDeadlyPoisonAction::Execute(Event)
{
...
bool UseInstantPoisonAction::Execute(Event)
{
    std::vector<std::string> poison_suffixs = {" IX", " VIII", " VII", " VI", " V", " IV", " III", " II", ""};
    std::vector<Item*> items;
    std::string poison_name;
...
bool UseInstantPoisonOffHandAction::Execute(Event)
{
    std::vector<std::string> poison_suffixs = {" IX", " VIII", " VII", " VI", " V", " IV", " III", " II", ""};
    std::vector<Item*> items;
    std::string poison_name;

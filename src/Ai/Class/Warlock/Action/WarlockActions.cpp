...
bool CreateSoulShardAction::Execute(Event)
{
...
bool DestroySoulShardAction::Execute(Event)
{
...
bool UseSoulstoneSelfAction::Execute(Event)
{
...
bool UseSoulstoneMasterAction::Execute(Event)
{
...
bool UseSoulstoneTankAction::Execute(Event)
{
    CleanupSoulstoneReservations();
...
bool UseSoulstoneHealerAction::Execute(Event)
{
    CleanupSoulstoneReservations();
...
bool CastCreateFirestoneAction::Execute(Event)
{

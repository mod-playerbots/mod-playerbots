...
public:
    ...
    bool Execute(Event /*event*/) override { return botAI->GetServices().GetSpellService().CastSpell(60053, GetTarget()); }
    bool isUseful() override
    {
...
public:
    ...
    bool Execute(Event /*event*/) override { return botAI->GetServices().GetSpellService().CastSpell(60052, GetTarget()); }
    bool isUseful() override
    {
        Unit* target = GetTarget();
        if (!target)
...
public:
    ...
    bool Execute(Event /*event*/) override { return botAI->GetServices().GetSpellService().CastSpell(60051, GetTarget()); }
    bool isUseful() override
    {
        Unit* target = GetTarget();
        if (!target)
...
public:
    ...
    bool Execute(Event /*event*/) override { return botAI->GetServices().GetSpellService().CastSpell(53301, GetTarget()); }
    bool isUseful() override
    {
        Unit* target = GetTarget();
        if (!target)

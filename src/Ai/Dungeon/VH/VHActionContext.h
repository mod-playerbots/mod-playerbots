...
class WotlkDungeonVHActionContext : public NamedObjectContext<Action>
{
    public:
        WotlkDungeonVHActionContext() {
            ...
            creators["zuramat stop attack"] = &WotlkDungeonVHActionContext::zuramat_stop_attack;
        }
    private:
        ...
        static Action* zuramat_stop_attack(PlayerbotAI* ai) { return new ZuramatStopAttackAction(ai); }
};

...
class WotlkDungeonUPActionContext : public NamedObjectContext<Action>
{
    public:
        WotlkDungeonUPActionContext() {
            ...
            creators["ymiron stop attack"] = &WotlkDungeonUPActionContext::ymiron_stop_attack;
        }
    private:
        ...
        static Action* ymiron_stop_attack(PlayerbotAI* ai) { return new DropTargetAction(ai); }
};

...
bool PlayerbotAIConfig::Initialize()
{
    ...
    lootRollDisenchant = sConfigMgr->GetOption<bool>("AiPlayerbot.LootRollDisenchant", true);
    lootRollGreed = sConfigMgr->GetOption<bool>("AiPlayerbot.LootRollGreed", false);

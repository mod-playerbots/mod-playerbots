...
void StrengthOfEarthTotemStrategy::InitTriggers(std::vector<TriggerNode*>& triggers)
{
    ...
    triggers.push_back(new TriggerNode("set strength of earth totem", { new NextAction("set strength of earth totem", 60.0f) }));
    triggers.push_back(new TriggerNode("no earth totem", { new NextAction("strength of earth totem", 55.0f) }));
}
...
{
    GenericShamanStrategy::InitTriggers(triggers);
    triggers.push_back(new TriggerNode("set stoneskin totem", { new NextAction("set stoneskin totem", 60.0f) }));
    triggers.push_back(new TriggerNode("no earth totem", { new NextAction("stoneskin totem", 55.0f) }));
}
...
{
    GenericShamanStrategy::InitTriggers(triggers);
    triggers.push_back(new TriggerNode("set tremor totem", { new NextAction("set tremor totem", 60.0f) }));
    triggers.push_back(new TriggerNode("no earth totem", { new NextAction("tremor totem", 55.0f) }));
}
...
{
    GenericShamanStrategy::InitTriggers(triggers);
    triggers.push_back(new TriggerNode("set earthbind totem", { new NextAction("set earthbind totem", 60.0f) }));
    triggers.push_back(new TriggerNode("no earth totem", { new NextAction("earthbind totem", 55.0f) }));
}
...
{
    GenericShamanStrategy::InitTriggers(triggers);
    triggers.push_back(new TriggerNode("set searing totem", { new NextAction("set searing totem", 60.0f) }));
    triggers.push_back(new TriggerNode("no fire totem", { new NextAction("searing totem", 55.0f) }));
}
...
{
    GenericShamanStrategy::InitTriggers(triggers);
    triggers.push_back(new TriggerNode("set magma totem", { new NextAction("set magma totem", 60.0f) }));
    triggers.push_back(new TriggerNode("no fire totem", { new NextAction("magma totem", 55.0f) }));
}
...
{
    GenericShamanStrategy::InitTriggers(triggers);
    triggers.push_back(new TriggerNode("set flametongue totem", { new NextAction("set flametongue totem", 60.0f) }));
    triggers.push_back(new TriggerNode("no fire totem", { new NextAction("flametongue totem", 55.0f) }));
}
...
void TotemOfWrathStrategy::InitTriggers(std::vector<TriggerNode*>& triggers)
{
    ...
    {
        triggers.push_back(new TriggerNode("set totem of wrath", { new NextAction("set totem of wrath", 60.0f) }));
    }
    else if (bot->HasSpell(8227))
    {
        triggers.push_back(new TriggerNode("set flametongue totem", { new NextAction("set flametongue totem", 60.0f) }));
    }
    triggers.push_back(new TriggerNode("no fire totem", { new NextAction("totem of wrath", 55.0f) }));
}
...
{
    GenericShamanStrategy::InitTriggers(triggers);
    triggers.push_back(new TriggerNode("set frost resistance totem", { new NextAction("set frost resistance totem", 60.0f) }));
    triggers.push_back(new TriggerNode("no fire totem", { new NextAction("frost resistance totem", 55.0f) }));
}
...
{
    GenericShamanStrategy::InitTriggers(triggers);
    triggers.push_back(new TriggerNode("set healing stream totem", { new NextAction("set healing stream totem", 60.0f) }));
    triggers.push_back(new TriggerNode("no water totem", { new NextAction("healing stream totem", 55.0f) }));
}
...
{
    GenericShamanStrategy::InitTriggers(triggers);
    triggers.push_back(new TriggerNode("set mana spring totem", { new NextAction("set mana spring totem", 60.0f) }));
    triggers.push_back(new TriggerNode("no water totem", { new NextAction("mana spring totem", 55.0f) }));
}
...
void CleansingTotemStrategy::InitTriggers(std::vector<TriggerNode*>& triggers)
{
    ...
    {
        triggers.push_back(new TriggerNode("set cleansing totem", { new NextAction("set cleansing totem", 60.0f) }));
    }
    else if (bot->HasSpell(5675))
    {
        triggers.push_back(new TriggerNode("set mana spring totem", { new NextAction("set mana spring totem", 60.0f) }));
    }
    triggers.push_back(new TriggerNode("no water totem", { new NextAction("cleansing totem", 55.0f) }));
}
...
{
    GenericShamanStrategy::InitTriggers(triggers);
    triggers.push_back(new TriggerNode("set fire resistance totem", { new NextAction("set fire resistance totem", 60.0f) }));
    triggers.push_back(new TriggerNode("no water totem", { new NextAction("fire resistance totem", 55.0f) }));
}
...
void WrathOfAirTotemStrategy::InitTriggers(std::vector<TriggerNode*>& triggers)
{
    ...
    {
        triggers.push_back(new TriggerNode("set wrath of air totem", { new NextAction("set wrath of air totem", 60.0f) }));
    }
    else if (bot->HasSpell(8177))
    {
        triggers.push_back(new TriggerNode("set grounding totem", { new NextAction("set grounding totem", 60.0f) }));
    }
    triggers.push_back(
        new TriggerNode("no air totem", { new NextAction("wrath of air totem", 55.0f) }));
}
...
void WindfuryTotemStrategy::InitTriggers(std::vector<TriggerNode*>& triggers)
{
    ...
    {
        triggers.push_back(new TriggerNode("set windfury totem", { new NextAction("set windfury totem", 60.0f) }));
    }
    else if (bot->HasSpell(8177))
    {
        triggers.push_back(new TriggerNode("set grounding totem", { new NextAction("set grounding totem", 60.0f) }));
    }
    triggers.push_back(new TriggerNode("no air totem", { new NextAction("windfury totem", 55.0f) }));
}
...
{
    GenericShamanStrategy::InitTriggers(triggers);
    triggers.push_back(new TriggerNode("set nature resistance totem", { new NextAction("set nature resistance totem", 60.0f) }));
    triggers.push_back(new TriggerNode("no air totem", { new NextAction("nature resistance totem", 55.0f) }));
}
...
void GroundingTotemStrategy::InitTriggers(std::vector<TriggerNode*>& triggers)
{
    GenericShamanStrategy::InitTriggers(triggers);
    triggers.push_back(new TriggerNode("set grounding totem", { new NextAction("set grounding totem", 60.0f) }));
    triggers.push_back(new TriggerNode("no air totem", { new NextAction("grounding totem", 55.0f) }));
}

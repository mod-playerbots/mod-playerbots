...
private:
    ...
    static ActionNode* summon_succubus([[maybe_unused]] PlayerbotAI* botAI)
    {
        return new ActionNode("summon succubus",
                              /*P*/ {},
                              /*A*/ { new NextAction("summon voidwalker") },
                              /*C*/ {});
    }
    static ActionNode* summon_felhunter([[maybe_unused]] PlayerbotAI* botAI)
    {
        return new ActionNode("summon felhunter",
                              /*P*/ {},
                              /*A*/ { new NextAction("summon succubus") },
                              /*C*/ {});
    }
    static ActionNode* summon_felguard([[maybe_unused]] PlayerbotAI* botAI)
    {
        return new ActionNode("summon felguard",
                              /*P*/ {},
                              /*A*/ { new NextAction("summon felhunter") },
                              /*C*/ {});
    }
};
...
void GenericWarlockNonCombatStrategy::InitTriggers(std::vector<TriggerNode*>& triggers)
{
    ...
    triggers.push_back(new TriggerNode("no pet", { new NextAction("fel domination", 30.0f) }));
    triggers.push_back(new TriggerNode("no soul shard", { new NextAction("create soul shard", 60.0f) }));
    triggers.push_back(new TriggerNode("too many soul shards", { new NextAction("destroy soul shard", 60.0f) }));
    triggers.push_back(new TriggerNode("soul link", { new NextAction("soul link", 28.0f) }));
    triggers.push_back(new TriggerNode("demon armor", { new NextAction("fel armor", 27.0f) }));
    triggers.push_back(new TriggerNode("no healthstone", { new NextAction("create healthstone", 26.0f) }));
    triggers.push_back(new TriggerNode("no soulstone", { new NextAction("create soulstone", 25.0f) }));
    triggers.push_back(new TriggerNode("life tap", { new NextAction("life tap", 23.0f) }));
}
...
{
    triggers.push_back(new TriggerNode("no pet", { new NextAction("summon imp", 29.0f) }));
    triggers.push_back(new TriggerNode("wrong pet", { new NextAction("summon imp", 29.0f) }));
}
...
{
    triggers.push_back(new TriggerNode("no pet", { new NextAction("summon voidwalker", 29.0f) }));
    triggers.push_back(new TriggerNode("wrong pet", { new NextAction("summon voidwalker", 29.0f) }));
}
...
{
    triggers.push_back(new TriggerNode("no pet", { new NextAction("summon succubus", 29.0f) }));
    triggers.push_back(new TriggerNode("wrong pet", { new NextAction("summon succubus", 29.0f) }));
}
...
{
    triggers.push_back(new TriggerNode("no pet", { new NextAction("summon felhunter", 29.0f) }));
    triggers.push_back(new TriggerNode("wrong pet", { new NextAction("summon felhunter", 29.0f) }));
}
...
{
    triggers.push_back(new TriggerNode("no pet", { new NextAction("summon felguard", 29.0f) }));
    triggers.push_back(new TriggerNode("wrong pet", { new NextAction("summon felguard", 29.0f) }));
}
...
{
    triggers.push_back(new TriggerNode("soulstone", { new NextAction("soulstone self", 24.0f) }));
}
...
{
    triggers.push_back(new TriggerNode("soulstone", { new NextAction("soulstone master", 24.0f) }));
}
...
{
    triggers.push_back(new TriggerNode("soulstone", { new NextAction("soulstone tank", 24.0f) }));
}
...
{
    triggers.push_back(new TriggerNode("soulstone", { new NextAction("soulstone healer", 24.0f) }));
}
...
{
    triggers.push_back(new TriggerNode("no spellstone", { new NextAction("create spellstone", 24.0f) }));
    triggers.push_back(new TriggerNode("spellstone", { new NextAction("spellstone", 24.0f) }));
}
...
{
    triggers.push_back(new TriggerNode("no firestone", { new NextAction("create firestone", 24.0f) }));
    triggers.push_back(new TriggerNode("firestone", { new NextAction("firestone", 24.0f) }));
}

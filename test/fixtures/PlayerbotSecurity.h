...
/**
 * @brief Test fixture stub for PlayerbotSecurity.h
 *
 * This provides the minimum definitions needed for unit testing
 * without requiring the full AzerothCore context.
 */
